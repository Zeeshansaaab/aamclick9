                            ...
                            <div class="col-lg-6 col-md-10">
                                <div class="header-caption">
                                    ...
                                    <ul class="header-action btns-inline">
                                        <li><a href="#" class="btn btn-primary btn-lg btn-round"><span>Try it For Free!</span></a></li>
                                    </ul>
                                </div><!-- .header-caption -->
                            </div><!-- .col -->
                        </div><!-- .row -->
                ...
                <div class="container">
                    <div class="row flex-row-reverse align-items-center justify-content-between g-gs">
                        ...
                        <div class="col-xl-6 col-lg-7">
                            <div class="text-block">
                                <h2 class="title text-dark text-center text-lg-left">Instantly upload any software usage SaaS dashlite data</h2>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-10">
                            <div class="row align-items-center g-0">
                                        ...
                                        <div class="card-inner card-inner-xl">
                                            <div class="text-block">
                                                ...
                                                <ul class="btns-inline pt-4">
                                                    <li><a href="#" class="btn btn-round btn-xl btn-primary fs-16px">Purchase Now for $50</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-5">
                                    <div class="card card-shadow card-bd-right-3px round-xl ml-lg-n7 ml-md-n5 mx-4 mr-md-0 mt-md-0 mt-n4">
                                        <div class="card-inner card-inner-lg">
                                            <div class="text-block is-compact pr-3">
                                                ...
                                                <ul class="btns-inline pt-2">
                                                    <li><a href="#" class="btn btn-lg btn-round btn-secondary"> <span>Purchase Now for $29</span><em class="icon ni ni-arrow-long-right"></em></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
